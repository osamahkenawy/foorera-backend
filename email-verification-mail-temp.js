const getEmailVerificationMailTemp = (code) => {
  const html = `<html xmlns="http://www.w3.org/1999/xhtml"><head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <meta name="viewport" content="width=device-width">
  <title>Foorera Email Verification</title>
    <style type="text/css">
  /* -------------------------------------
    GLOBAL
  ------------------------------------- */
...
<body bgcolor="#ffffff">
  ...
  <div align="center">
    <table class="head-wrap w320 full-width-gmail-android" bgcolor="#f9f8f8" cellpadding="0" cellspacing="0" border="0">
      <tbody><tr>
        <td background="https://foorera.com/images/ver-email-temp-header.png" bgcolor="#ffffff" width="100%" height="8" valign="top">
          <!--[if gte mso 9]>
      ...
      <tr class="header-background">
        <td class="header container" align="center">
          <div class="content">
            <span class="brand">
              <b style="font-size: larger; color: #3677a7;">FOORERA</b>
            </span>
          </div>
        </td>
      </tr>
            ...
            <table cellspacing="0">
              <tbody><tr>
                <td>
                  <table class="soapbox">
                    <tbody><tr>
                      <td class="soapbox-title">Your verification code</td>
                    </tr>
                  </tbody></table>
                        ...
                        <table class="status" bgcolor="#fffeea" cellspacing="0">
                          <tbody><tr>
                            <td class="status-cell">
                              <b style="font-size: xx-large; letter-spacing: 5;">${code}</b>
                            </td>
                          </tr>
                        </tbody></table>
                      </td>
    ...
    <table class="footer-wrap w320 full-width-gmail-android" bgcolor="#e5e5e5" style="margin-top: 52px;">
      <tbody><tr>
        <td>
          <div class="content"><span class="footer-group">
              <a href="https://foorera.com/">Visit our website</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="mailto:support@foorera.com">Contact support</a>
            </span>
          </div>
        </td>
      </tr>
...
module.exports = { getEmailVerificationMailTemp };
